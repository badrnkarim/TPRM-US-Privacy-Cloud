<!--
Document ID: TPRM-10-DataPulse-RR
Title: Residual Risk — DataPulse Analytics (Data Processor) (High, Sanitized)
...
-->
# Residual Risk — DataPulse Analytics (Data Processor)
Residual risk: **15** (portfolio calculation)
