<!--
Document ID: TPRM-00-AUTH
Title: Portfolio Authenticity Statement
...
This repository is a **personal TPRM program portfolio** authored and maintained by **Badr Karim**.
